            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="ShoppingCart.php?action=add&ID=<?php echo $row["Product ID"]; ?>">
                ...
                if(!empty($_SESSION["ShoppingCart"])){
                    ...
                    foreach ($_SESSION["ShoppingCart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="ShoppingCart.php?action=delete&ID=<?php echo $value["product_id"]; ?>"><span class="text-danger">Remove Item</span></a></td>
