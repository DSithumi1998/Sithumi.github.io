<?php
	...
	//post the data to db
    if (isset($_POST["add"])){
        if (isset($_SESSION["ShoppingCartBaskets"])){
            $item_array_id = array_column($_SESSION["ShoppingCartBaskets"],"product_id");
            if (!in_array($_GET["ID"],$item_array_id)){
                $count = count($_SESSION["ShoppingCartBaskets"]);
                $item_array = array(
                    'product_id' => $_GET["ID"],
                ...
                $_SESSION["ShoppingCartBaskets"][$count] = $item_array;
                header('Location:ShoppingCartBaskets.php');
            }else{
            ...
            $_SESSION["ShoppingCartBaskets"][0] = $item_array;
        }
    }
    ...
    if (isset($_GET["action"])){
        if ($_GET["action"] == "delete"){
            foreach ($_SESSION["ShoppingCartBaskets"] as $keys => $value){
                if ($value["product_id"] == $_GET["ID"]){
                    unset($_SESSION["ShoppingCartBaskets"][$keys]);
...
<a href="HomePage.html"><img src="NewBack.jpg" width="30" height="30" /></a>
    ...
    <div class="container" style="width: 65%">
        ...
        <h3>Flower Baskets</h3>
        
        <?php
		
			//get the data from db
            $query = "SELECT * FROM FlowerBaskets";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="ShoppingCartBaskets.php?action=add&ID=<?php echo $row["Product ID"]; ?>">
        ...
        <div class="table-responsive">
            ...
            <?php
                if(!empty($_SESSION["ShoppingCartBaskets"])){
                    $total = 0;
                    foreach ($_SESSION["ShoppingCartBaskets"] as $key => $value) {
                        ?>
                        <tr>
                            ...
                            <td><a href="ShoppingCartBaskets.php?action=delete&ID=<?php echo $value["product_id"]; ?>"><span
                        ...
                        <tr>
                            ...
                            <td>
                            <?php echo '<script>alert"Thank You For Ordering"</script>';?>
